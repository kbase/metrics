...
docker-compose run metrics ../bin/upload_user_stats.sh
docker-compose run metrics ../bin/upload_app_stats.sh
docker-compose run metrics ../bin/upload_app_category_mappings.sh
