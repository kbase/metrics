...
def get_workspace_shares(workspaces_dict, kb_staff):
    ...
    shares_query = db.workspaceACLs.find({"perm" : { "$in": [ 10,20,30 ]}},{"id" : 1, "user" : 1, "perm" : 1, "_id" : 0});
...
def get_workspace_share_details():
    ...
    (workspaces_dict,max_shared_count) = get_workspace_shares(workspaces_dict, kb_staff)
