...
#            print("WS_OBJECTS_TO_TRACK: " + str(ws_objects_to_track))
            ...
            all_copied_objects_from_ws_list = grow_copied_list(copied_to_lookup_dict, [], ws_objects_to_track)
#            print("ALL COPIED OBJECTS LIST: " + str(all_copied_objects_from_ws_list))
            for object_copied in all_copied_objects_from_ws_list:
...
def get_existing_unique_copied_workspaces(db_connection):
    ...
    get_publication_unique_workspaces_statement = ("select published_ws_id, copied_ws_id from metrics.doi_unique_workspaces;")
...
def get_existing_unique_copied_usernames(db_connection):
    ...
    cursor = db_connection.cursor()
    get_publication_unique_usernames_statement = ("select published_ws_id, copied_username from metrics.doi_unique_usernames;")
