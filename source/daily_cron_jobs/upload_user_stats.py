...
user_stats_dict = methods_upload_user_stats.get_profile_info(user_stats_dict,batch_size=100,max_retries=1)
print("--- gather data %s seconds ---" % (time.time() - start_time))
methods_upload_user_stats.upload_user_data(user_stats_dict)
print(
    "--- including user info and user_stats upload %s seconds ---"
