...
def get_nodes_data(db_shock, uuid_user_mapping_dict, start_date, end_date):
    ...
    nodes_query = db_shock.Nodes.find(
        {"created_on": {"$gt": start_date, "$lt": end_date}},
...
def upload_file_stats_data(users_date_summary_dict):
    ...
    file_stats_insert_statement = (
        "insert into metrics.file_storage_stats "
    ...
    file_stats_update_statement = (
        "update metrics.file_storage_stats "
...
def process_file_stats_data(
    ...
    users_date_summary_dict = get_nodes_data(
        db_shock, uuid_user_mapping_dict, start_date, end_date
    )
